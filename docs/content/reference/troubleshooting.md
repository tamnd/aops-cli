...
Most of these come down to network reality or how aops serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

aops rate-limits like any public site. aops already paces
...
Where a surface is gated, aops reads a cookie or token you supply
...
`aops`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what aops actually did
